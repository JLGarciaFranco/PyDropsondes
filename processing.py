...
# Define function.
def read_process_write(filelist,track,storm):
        """
...
#        sampleperiods={datetime.datetime(2005, 9, 20, 10, 0, 41):datetime.datetime(2005,9,21,3,0,0),datetime.datetime(2005,9,21,15,0,0):datetime.datetime(2005,9,22,3,0,0),datetime.datetime(2005, 9, 22, 5, 33, 41):datetime.datetime(2005,9,23,3,0,0),datetime.datetime(2005,9,23,6,0,0):datetime.datetime(2005, 9, 24, 7, 3, 27, 0)}
#        sampleperiods={datetime.datetime(2005,9,22,13,0,0):datetime.datetime(2005,9,23,3,0,0),datetime.datetime(2005,9,23,16,0,0):datetime.datetime(2005, 9, 24, 7, 3, 27, 0)}
        omega=7.2921*(10**-5)
